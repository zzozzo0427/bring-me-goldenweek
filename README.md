...
一見普通のカレンダーに見えますが、意図的に操作を難しく設計した「バッドUI（Bad UI）」を採用しています。ユーザーは数々の理不尽なUIギミックを乗り越え、日付を操作してゴールデンウィークを強制的に引き寄せなければなりません。
...
## 🎯 特徴 (Features)
- **高難易度なUI体験:** 直感に反する操作を要求する、意図的に設計されたカレンダーギミック。
